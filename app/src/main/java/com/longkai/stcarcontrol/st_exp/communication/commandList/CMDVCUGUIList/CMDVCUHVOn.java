...
public class CMDVCUHVOn extends BaseCommand {
    ...
    public CMDVCUHVOn(boolean state){
        try{
            data = new byte[3];
            dataLength = 3;
            data[0] = 0x03;
            data[1] = COMMAND_VCU_HV_Power_ON;
    ...
    public BaseResponse toResponse(byte[] data) throws Exception {
        Response response = new CMDVCUHVOn.Response(getCommandId());
        return response;
    }
    ...
    public byte getCommandId() {
        return COMMAND_VCU_HV_Power_ON;
    }
}
